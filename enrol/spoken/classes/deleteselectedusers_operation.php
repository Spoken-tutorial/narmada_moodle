...
/**
 * A bulk operation for the spoken enrolment plugin to delete selected users enrolments.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_spoken_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('deleteselectedusers', 'enrol_spoken');
    }
     ...
     * @return enrol_spoken_deleteselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkdeleteenrolment', 'enrol_spoken');
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_spoken');

        return new enrol_spoken_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        if (!has_capability("enrol/spoken:unenrol", $manager->get_context())) {
            return false;
        }
